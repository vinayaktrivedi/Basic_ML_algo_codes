...
plt.title('First data file, Generative with different variance')
plt.xlabel('x1')
plt.ylabel('x2')
plt.legend(loc=2)
plt.savefig("v1_non")
...
var_0=var_1
plt.contour(x_range, y_range.ravel(), ((1/(2*var_0))*((xc-mean_0[0][0])**2+(yc-mean_0[0][1])**2))-((1/(2*var_1))*((xc-mean_1[0][0])**2+(yc-mean_1[0][1])**2))+(math.log(var_0)-math.log(var_1)), [0])
plt.title('Data file 1, Generative with equal variance')
plt.xlabel('x1')
plt.ylabel('x2')
plt.legend(loc=2)
plt.savefig("v1_lin")
...
print(w)
print(b)
plt.title('Linear SVM for datafile 1')
plt.xlabel('x1')
plt.ylabel('x2')
plt.legend(loc=2)
plt.savefig("v1_svm")
